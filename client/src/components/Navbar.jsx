    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={() => setOpen(false)}>
                <img className='h-15' src={assets.logo1} alt="Sabzi Mart" />
            </NavLink>
                ...
                {!user ? (
                    <div className="flex items-center gap-3">
                        ...
                        <button 
                            ...
                            className="cursor-pointer px-6 py-2 bg-gray-800 hover:bg-gray-900 transition text-white rounded-full text-sm"
                        >
                            Login as Admin
                        </button>
                    </div>
                ...
                <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden z-50`}>
                    ...
                    {!user ? (
                        <div className="flex flex-col gap-2 w-full mt-2">
                            ...
                            }} className="cursor-pointer px-6 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full text-sm w-full">
                                Login as User
                            </button>
                            <button onClick={() => {
                                setOpen(false);
                                navigate('/seller');
                            }} className="cursor-pointer px-6 py-2 bg-gray-800 hover:bg-gray-900 transition text-white rounded-full text-sm w-full">
                                Login as Admin
                            </button>
                        </div>
                    ) : (
